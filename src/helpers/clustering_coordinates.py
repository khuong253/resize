...
import os 
import sys
sys.path.append("/content/drive/MyDrive/Projects/layout-dm/src/trainer/trainer")
import omegaconf
import torch
...
result_dir = os.path.join(args.result_dir, str(args.seed)) 
...
weight_path = f"{result_dir}/{name}_max{dataset_cfg.max_seq_length}_{args.algorithm}_train_clusters.pkl"
